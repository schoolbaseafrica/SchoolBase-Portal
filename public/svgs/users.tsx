export default function Users(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      width="20"
      height="20"
      ...
      {...props} // <-- this makes props work (color, className, etc.)
    >
      <path
        ...
        stroke="currentColor" // <-- crucial: uses parent's color!
        strokeWidth="2"
        strokeLinecap="round"
